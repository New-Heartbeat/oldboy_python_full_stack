...
变量就是可以变化的量，量指的是事物的状态，比如人的年龄、性别、游戏角色的等级等等

二、为什么要有变量？
为了让计算机能够像人一样去记忆事物的某种状态，并且状态是可以发生变化的
详细地说：
程序执行的本质就是一系列状态的变化，变是程序执行的直接体现，所以我们需要有一种机制能够反映这种变化
...
id相同的情况下，值一定相同，x is y 成立, x == y也必然成立
x = 'info:Egon:18'
y = 'info:Egon:18'
id(x)
Out[3]: 2535811191600
...
# 了解：小整数池[-5, 256]
# 从python解释器启动那一刻开始，就会在内存中事先申请好一系列内存空间放好常用的整数
